...
use crate::products::sc2::{Sc2Assets, theme::FONT_NAVIGATION};
...
#[must_use]
pub fn chrome(width: f32, height: f32, frame: Option<ImageSource>, assets: &Sc2Assets) -> Div {
...
#[must_use]
pub fn header(layout: HeaderLayout, title: impl Into<SharedString>, assets: &Sc2Assets) -> Div {
