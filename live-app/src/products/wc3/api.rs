//! Warcraft III: Reforged Live feed DTOs and product-scoped transport.
...
impl ChannelSummary {
    pub fn label(&self) -> String {
        ...
        self.key
            .split_once(':')
            .map_or_else(|| self.key.clone(), |(_, tail)| tail.to_owned())
    }
}
...
impl Sender {
    pub fn display_name(&self) -> String {
        self.name
            .clone()
            .unwrap_or_else(|| format!("Player {}", self.handle))
    }
}
