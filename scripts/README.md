...
| Script | Purpose |
| --- | --- |
| `build-macos-app.zsh` | Build the macOS app. |
| `build-windows-release-macos.zsh` | Cross-compile the Windows app. |
| `package-macos.zsh` | Create the macOS DMG. |
| `prepare-app-assets.zsh` | Prepare bundled game assets. |
| `stage-stimpak-macos.zsh` | Build and stage macOS Stimpak libraries. |
