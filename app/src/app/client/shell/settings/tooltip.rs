...
impl SettingsComponent {
    ...
    pub(in crate::app::client) fn tooltip_card(
        &self,
        skin: &SettingsSkin,
        assets: &Sc2Assets,
    ) -> Option<AnyElement> {
        ...
        // StarCraft II keeps its painted tooltip plate; the other realms
        // get a plate in their own stone or steel, same size, same seat
        let shell = if skin.variant == ui_shared_modal::ModalVariant::Sc2 {
            ui_controls::tooltip_shell(380.0, 94.0, assets.tooltip_fill.clone())
        } else {
            div()
                .relative()
                .w(px(380.0))
                ...
                .overflow_hidden()
                .rounded(px(1.0))
                .bg(rgba(skin.tooltip_fill))
                .border_1()
                .border_color(rgba(skin.tooltip_edge))
                .shadow(vec![
        ...
        let tooltip = shell
            ...
            .child(
                div()
                    ...
                    .items_center()
                    .text_size(px(14.0))
                    .text_color(rgb(skin.tooltip_title))
                    .child(title),
            )
            .child(
                div()
                    ...
                    .text_size(px(12.0))
                    .line_height(px(15.0))
                    .text_color(rgb(skin.tooltip_detail))
                    .child(detail),
            );
