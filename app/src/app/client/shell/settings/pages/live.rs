...
impl SettingsComponent {
    pub(in crate::app::client) fn live_settings_page(
        &self,
        ...
        if let Some(url) = live_link_target {
            let link_lit = skin.link_lit;
            live_link_view = live_link_view
                .cursor_pointer()
                .underline()
                .text_color(rgb(skin.link))
                .hover(move |style| style.text_color(rgb(link_lit)))
        ...
        let mut copy_button = div()
            ...
            .text_color(rgb(skin.link))
            .cursor_pointer()
            .hover(move |style| style.text_color(rgb(skin.link_lit)).shadow_lg())
