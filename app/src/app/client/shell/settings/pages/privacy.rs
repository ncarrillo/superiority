...
impl SettingsComponent {
    ...
    /// rewrite. The data behind it still arrives and still lives in
    /// `social.blocked_accounts`.
    #[expect(dead_code, reason = "kept for the move to the social pane")]
    pub(in crate::app::client) fn privacy_settings_page(
        &self,
