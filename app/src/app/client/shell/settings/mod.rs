...
pub(in crate::app::client) use model::{CheckboxAnimation, SettingsPage, SettingsPageTransition};
pub(in crate::app::client) use skin::SettingsSkin;
...
pub(in crate::app::client) struct SettingsComponent {
    pub(in crate::app::client) show_timestamps: bool,
    pub(in crate::app::client) show_membership: bool,
    pub(in crate::app::client) live_enabled: bool,
    pub(in crate::app::client) backgrounds: BTreeMap<Product, &'static str>,
    pub(in crate::app::client) active_settings_page: usize,
    pub(in crate::app::client) settings_page_transition: Option<SettingsPageTransition>,
    pub(in crate::app::client) settings_tooltip: Option<usize>,
    pub(in crate::app::client) checkbox_animations: [Option<CheckboxAnimation>; 3],
    pub(in crate::app::client) background_scroll: ScrollHandle,
    pub(in crate::app::client) privacy_scroll: ScrollHandle,
}

impl SettingsComponent {
    #[must_use]
    pub(in crate::app::client) fn background(&self, product: Product) -> &'static str {
        self.backgrounds
            .get(&product)
            .copied()
            .unwrap_or(BACKGROUNDS[0].path)
    }

    pub(in crate::app::client) fn set_background(
        &mut self,
        product: Product,
        background: &'static str,
    ) {
        self.backgrounds.insert(product, background);
    }

    pub(in crate::app::client) fn begin_checkbox_animation(
        &mut self,
        index: usize,
        from_checked: bool,
        to_checked: bool,
    ...
    pub(in crate::app::client) fn push_live_config(&self, uplink: &uplink::UplinkControl) {
    ...
    pub(in crate::app::client) fn toggle_live(&mut self, uplink: &uplink::UplinkControl) {
        let enabled = !self.live_enabled;
