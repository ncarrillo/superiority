...
impl superiority_core::bsn::FromBsn for AchievementCriteriaComparandChoice {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        ...
        match index {
            ...
            1i128 => Ok(Self::FourCharCode(<FourCc as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            2i128 => Ok(Self::Bool(<bool as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            3i128 => Ok(Self::USixteen(<u16 as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            4i128 => Ok(Self::UThirtyTwo(<u32 as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            5i128 => Ok(Self::USixtyFour(<u64 as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            6i128 => Ok(Self::SThirtyTwo(<i32 as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            7i128 => Ok(Self::UnlockableHandle(<super::achievement::AchievementCriteriaComparandChoiceUnlockableHandle as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a AchievementCriteriaComparandChoice variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for AchievementDataSegment {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            0i128 => Ok(Self::Achievements(<Vec<super::achievement::AchievementPersistentRecord> as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Criteria(<Vec<super::achievement::AchievementCriteriaUpdateRecord> as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            2i128 => Ok(Self::Notification(<super::achievement::AchievementDataSegmentNotification as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            3i128 => Ok(Self::Quests(<Vec<super::achievement::AchievementQuestUpdateRecord> as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a AchievementDataSegment variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for AchievementListenModeEnum {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
...
impl superiority_core::bsn::FromBsn for AchievementListenScopeEnum {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        match superiority_core::bsn::FromBsn::from_bsn(value)? {
...
impl superiority_core::bsn::FromBsn for AchievementNotificationEnum {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        match superiority_core::bsn::FromBsn::from_bsn(value)? {
