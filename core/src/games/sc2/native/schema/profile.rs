...
impl superiority_core::bsn::FromBsn for ClientProfileAddressQueryResponseResult {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        ...
        match index {
            0i128 => Ok(Self::Success(<super::profile::ClientProfileAddressQueryResponseResultSuccess as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Failure(<super::profile::ClientProfileAddressQueryResponseResultFailure as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientProfileAddressQueryResponseResult variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for ClientProfileSettingsTypeEnum {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
...
impl superiority_core::bsn::FromBsn for ProfileHeroStatSelection {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            1i128 => Ok(Self::AllForSeason(<super::profile::ProfileHeroStatSelectionAllForSeason as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            2i128 => Ok(Self::TopForSeason(<super::profile::ProfileHeroStatSelectionTopForSeason as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ProfileHeroStatSelection variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for ProfileProfileDataResponse {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            0i128 => Ok(Self::Start(<super::profile::ProfileProfileDataResponseStart as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Block(<Bytes as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            2i128 => Ok(Self::Failure(<u16 as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            3i128 => Ok(Self::Cache(<() as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ProfileProfileDataResponse variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for ProfileReadSelection {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            0i128 => Ok(Self::All(<super::profile::ProfileReadSelectionAll as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Slice(<super::profile::ProfileReadSelectionSlice as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            2i128 => Ok(Self::Random(<super::profile::ProfileReadSelectionRandom as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            3i128 => Ok(Self::MultiPath(<super::profile::ProfileReadSelectionMultiPath as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            4i128 => Ok(Self::Range(<super::profile::ProfileReadSelectionRange as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            5i128 => Ok(Self::HeroStats(<super::profile::ProfileHeroStatSelection as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ProfileReadSelection variant"))),
        }
    }
}
