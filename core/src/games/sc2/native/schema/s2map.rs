...
impl superiority_core::bsn::FromBsn for ClientS2MapGameGroupUpdateResults {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        ...
        match index {
            0i128 => Ok(Self::GameGroup(
                <Vec<super::s2map::S2MapShortLink> as superiority_core::bsn::FromBsn>::from_bsn(
                    inner,
                )?,
            )),
...
impl superiority_core::bsn::FromBsn for ClientS2MapS2ListMapFavoritesResponseResult {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            0i128 => Ok(Self::Success(<super::s2map::ClientS2MapS2ListMapFavoritesResponseResultSuccess as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Failure(<super::s2map::ClientS2MapS2ListMapFavoritesResponseResultFailure as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientS2MapS2ListMapFavoritesResponseResult variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for S2MapLinkEntryTypeEnum {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
