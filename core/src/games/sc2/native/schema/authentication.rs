...
impl superiority_core::bsn::FromBsn for ClientAuthenticationGenerateWebTokenResponseResult {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        ...
        match index {
            0i128 => Ok(Self::Success(<super::authentication::ClientAuthenticationGenerateWebTokenResponseResultSuccess as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Failure(<u16 as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientAuthenticationGenerateWebTokenResponseResult variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for ClientAuthenticationLogonResponseResult {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            0i128 => Ok(Self::Success(<super::authentication::ClientAuthenticationLogonResponseSuccess as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Failure(<super::authentication::ClientAuthenticationResponseFailure as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientAuthenticationLogonResponseResult variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for ClientAuthenticationResponseFailureResult {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            0i128 => Ok(Self::Update(<() as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Failure(<super::authentication::ClientAuthenticationResponseFailureResultFailure as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            2i128 => Ok(Self::VersionCheckDisconnect(<() as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientAuthenticationResponseFailureResult variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for ClientAuthenticationResumeResponseResult {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            0i128 => Ok(Self::Success(<super::authentication::ClientAuthenticationResumeResponseSuccess as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Failure(<super::authentication::ClientAuthenticationResponseFailure as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientAuthenticationResumeResponseResult variant"))),
        }
    }
}
