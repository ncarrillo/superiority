...
impl superiority_core::bsn::FromBsn for ClientS2MasterCurrentSeasonResponseResult {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        ...
        match index {
            0i128 => Ok(Self::Success(<super::s2master::ClientS2MasterCurrentSeasonResponseResultSuccess as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Failure(<u16 as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientS2MasterCurrentSeasonResponseResult variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for ClientS2MasterMMQGetListResponseResult {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        let (index, inner) = match value {
            superiority_core::bsn::value::BsnValue::Choice { index, value } => {
                (*index, value.as_ref())
        ...
        match index {
            0i128 => Ok(Self::Success(<super::s2master::ClientS2MasterMMQGetListResponseResultSuccess as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            1i128 => Ok(Self::Failure(<u16 as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientS2MasterMMQGetListResponseResult variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for S2MasterAdvertPostModeEnum {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
