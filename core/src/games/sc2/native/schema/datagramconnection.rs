...
impl superiority_core::bsn::FromBsn for ClientDatagramConnectionEndPointId {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        ...
        match index {
            0i128 => Ok(Self::PlayerTarget(<super::datagramconnection::ClientDatagramConnectionEndPointIdPlayerTarget as superiority_core::bsn::FromBsn>::from_bsn(inner)?)),
            other => Err(superiority_core::Error::BsnWire(format!("{other} is not a ClientDatagramConnectionEndPointId variant"))),
        }
    }
}
...
impl superiority_core::bsn::FromBsn for DatagramConnectionArbitrationNotifyEnum {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
...
impl superiority_core::bsn::FromBsn for DatagramConnectionNATTypeEnum {
    fn from_bsn(value: &superiority_core::bsn::value::BsnValue) -> superiority_core::Result<Self> {
        match superiority_core::bsn::FromBsn::from_bsn(value)? {
