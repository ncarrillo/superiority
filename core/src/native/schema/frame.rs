...
impl sc2_core::bsn::FromBsn for FrameHeaderData {
...
impl sc2_core::bsn::FromBsn for FrameHeaderDataTargetIds {
    fn from_bsn(value: &sc2_core::bsn::value::BsnValue) -> sc2_core::Result<Self> {
        let (index, inner) = match value {
            sc2_core::bsn::value::BsnValue::Choice { index, value } => (*index, value.as_ref()),
            other => {
...
impl sc2_core::bsn::FromBsn for FrameReplicationCommandEnum {
    fn from_bsn(value: &sc2_core::bsn::value::BsnValue) -> sc2_core::Result<Self> {
...
impl sc2_core::bsn::FromBsn for FrameTargetTypeEnum {
    fn from_bsn(value: &sc2_core::bsn::value::BsnValue) -> sc2_core::Result<Self> {
        match sc2_core::bsn::FromBsn::from_bsn(value)? {
...
impl sc2_core::bsn::FromBsn for FrameTypeEnum {
    fn from_bsn(value: &sc2_core::bsn::value::BsnValue) -> sc2_core::Result<Self> {
        match sc2_core::bsn::FromBsn::from_bsn(value)? {
